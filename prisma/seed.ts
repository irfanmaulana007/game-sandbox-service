...
export class FakerSeeder {
  ...
  private async seedMaps(): Promise<void> {
    ...
    const mountains: { name: string; difficulty: MapDifficulty }[] = [
      { name: 'Mt. Bromo', difficulty: 'easy' },
      { name: 'Mt. Ijen', difficulty: 'easy' },
      { name: 'Mt. Papandayan', difficulty: 'easy' },
      { name: 'Mt. Andong', difficulty: 'easy' },
      { name: 'Mt. Ungaran', difficulty: 'easy' },

      { name: 'Mt. Prau', difficulty: 'normal' },
      { name: 'Mt. Merbabu', difficulty: 'normal' },
      { name: 'Mt. Ciremai', difficulty: 'normal' },
      { name: 'Mt. Lawu', difficulty: 'normal' },
      { name: 'Mt. Gede', difficulty: 'normal' },
      { name: 'Mt. Agung', difficulty: 'normal' },
      { name: 'Mt. Semeru', difficulty: 'hard' },

      { name: 'Mt. Rinjani', difficulty: 'hard' },
      { name: 'Mt. Cikuray', difficulty: 'hard' },
      { name: 'Mt. Salak', difficulty: 'hard' },
      { name: 'Mt. Kerinci', difficulty: 'hard' },
      { name: 'Mt. Latimojong', difficulty: 'hard' },
      { name: 'Mt. Argopuro', difficulty: 'hard' },

      { name: 'Mt. Cartensz Pyramid', difficulty: 'extreme' },
      { name: 'Mt. Binaiya', difficulty: 'extreme' },
      { name: 'Mt. Leuser', difficulty: 'extreme' },
    ];
    ...
    for (const mountain of mountains) {
      ...
      const minLevel = randomizeMinLevel;
    ...
    //   const difficulty = getRandomByDistribution(
    //     this.config.maps.difficultyDistribution
    //   ) as MapDifficulty;
    //   const minLevel =
