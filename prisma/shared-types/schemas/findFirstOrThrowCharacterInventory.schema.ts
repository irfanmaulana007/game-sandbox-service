...
export const CharacterInventoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CharacterInventorySelect, Prisma.CharacterInventorySelect> = z.object({
...
export const CharacterInventoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    characterId: z.boolean().optional(),
    itemId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const CharacterInventoryFindFirstOrThrowSchema: z.ZodType<Prisma.CharacterInventoryFindFirstOrThrowArgs, Prisma.CharacterInventoryFindFirstOrThrowArgs> = z.object({ select: CharacterInventoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CharacterInventoryIncludeObjectSchema.optional()), orderBy: z.union([CharacterInventoryOrderByWithRelationInputObjectSchema, CharacterInventoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CharacterInventoryWhereInputObjectSchema.optional(), cursor: CharacterInventoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CharacterInventoryScalarFieldEnumSchema, CharacterInventoryScalarFieldEnumSchema.array()]).optional() }).strict();

export const CharacterInventoryFindFirstOrThrowZodSchema = z.object({ select: CharacterInventoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CharacterInventoryIncludeObjectSchema.optional()), orderBy: z.union([CharacterInventoryOrderByWithRelationInputObjectSchema, CharacterInventoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CharacterInventoryWhereInputObjectSchema.optional(), cursor: CharacterInventoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CharacterInventoryScalarFieldEnumSchema, CharacterInventoryScalarFieldEnumSchema.array()]).optional() }).strict();