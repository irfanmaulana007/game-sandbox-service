...
export const MonsterFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MonsterSelect, Prisma.MonsterSelect> = z.object({
...
export const MonsterFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    level: z.boolean().optional(),
    health: z.boolean().optional(),
