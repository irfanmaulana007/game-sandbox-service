...
export const CharacterEquipmentFindUniqueSchema = z.object({ select: CharacterEquipmentSelectObjectSchema.optional(), include: CharacterEquipmentIncludeObjectSchema.optional(), where: CharacterEquipmentWhereUniqueInputObjectSchema })