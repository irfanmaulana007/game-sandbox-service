...
export const CharacterAvgAggregateInputObjectSchema: z.ZodType<Prisma.CharacterAvgAggregateInputType, Prisma.CharacterAvgAggregateInputType> = z.object({
...
export const CharacterAvgAggregateInputObjectZodSchema = z.object({
  jobId: z.literal(true).optional(),
  level: z.literal(true).optional(),
  experience: z.literal(true).optional(),
  health: z.literal(true).optional(),
