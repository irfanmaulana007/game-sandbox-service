...
export const CharacterCreateWithoutBattleLogsInputObjectSchema: z.ZodType<Prisma.CharacterCreateWithoutBattleLogsInput, Prisma.CharacterCreateWithoutBattleLogsInput> = z.object({
...
export const CharacterCreateWithoutBattleLogsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  level: z.number().int().optional(),
  experience: z.number().int().optional(),
