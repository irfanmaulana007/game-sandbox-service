...
export const CharacterCreateWithoutEquipmentInputObjectSchema: z.ZodType<Prisma.CharacterCreateWithoutEquipmentInput, Prisma.CharacterCreateWithoutEquipmentInput> = z.object({
...
export const CharacterCreateWithoutEquipmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  level: z.number().int().optional(),
  experience: z.number().int().optional(),
