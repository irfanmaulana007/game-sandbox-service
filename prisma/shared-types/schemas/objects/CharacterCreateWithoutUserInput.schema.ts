...
export const CharacterCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.CharacterCreateWithoutUserInput, Prisma.CharacterCreateWithoutUserInput> = z.object({
...
export const CharacterCreateWithoutUserInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  level: z.number().int().optional(),
  experience: z.number().int().optional(),
