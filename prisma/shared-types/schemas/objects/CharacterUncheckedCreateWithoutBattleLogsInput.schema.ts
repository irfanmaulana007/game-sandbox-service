...
export const CharacterUncheckedCreateWithoutBattleLogsInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedCreateWithoutBattleLogsInput, Prisma.CharacterUncheckedCreateWithoutBattleLogsInput> = z.object({
...
export const CharacterUncheckedCreateWithoutBattleLogsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  userId: z.string(),
  name: z.string(),
  jobId: z.number().int(),
