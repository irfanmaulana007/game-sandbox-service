...
export const CharacterUncheckedCreateWithoutEquipmentInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedCreateWithoutEquipmentInput, Prisma.CharacterUncheckedCreateWithoutEquipmentInput> = z.object({
...
export const CharacterUncheckedCreateWithoutEquipmentInputObjectZodSchema = z.object({
  id: z.string().optional(),
  userId: z.string(),
  name: z.string(),
  jobId: z.number().int(),
