...
export const CharacterUncheckedCreateWithoutInventoryInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedCreateWithoutInventoryInput, Prisma.CharacterUncheckedCreateWithoutInventoryInput> = z.object({
...
export const CharacterUncheckedCreateWithoutInventoryInputObjectZodSchema = z.object({
  id: z.string().optional(),
  userId: z.string(),
  name: z.string(),
  jobId: z.number().int(),
