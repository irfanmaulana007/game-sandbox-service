...
export const CharacterUncheckedCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedCreateWithoutUserInput, Prisma.CharacterUncheckedCreateWithoutUserInput> = z.object({
...
export const CharacterUncheckedCreateWithoutUserInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  jobId: z.number().int(),
  level: z.number().int().optional(),
