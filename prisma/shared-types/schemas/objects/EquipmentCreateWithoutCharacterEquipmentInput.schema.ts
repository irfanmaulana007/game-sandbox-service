...
export const EquipmentCreateWithoutCharacterEquipmentInputObjectSchema: z.ZodType<Prisma.EquipmentCreateWithoutCharacterEquipmentInput, Prisma.EquipmentCreateWithoutCharacterEquipmentInput> = z.object({
  name: z.string(),
...
export const EquipmentCreateWithoutCharacterEquipmentInputObjectZodSchema = z.object({
  name: z.string(),
  type: EquipmentTypeSchema,
  rarity: RaritySchema,
  minLevel: z.number().int().optional(),
