...
export const MonsterCountAggregateInputObjectSchema: z.ZodType<Prisma.MonsterCountAggregateInputType, Prisma.MonsterCountAggregateInputType> = z.object({
...
export const MonsterCountAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  name: z.literal(true).optional(),
  level: z.literal(true).optional(),
  health: z.literal(true).optional(),
