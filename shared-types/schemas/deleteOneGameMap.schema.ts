...
export const GameMapDeleteOneSchema = z.object({ select: GameMapSelectObjectSchema.optional(), include: GameMapIncludeObjectSchema.optional(), where: GameMapWhereUniqueInputObjectSchema  })