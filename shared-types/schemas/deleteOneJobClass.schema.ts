...
export const JobClassDeleteOneSchema = z.object({ select: JobClassSelectObjectSchema.optional(), include: JobClassIncludeObjectSchema.optional(), where: JobClassWhereUniqueInputObjectSchema  })