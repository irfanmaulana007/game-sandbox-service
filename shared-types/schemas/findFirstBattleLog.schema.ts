...
export const BattleLogFindFirstSelectSchema: z.ZodType<Prisma.BattleLogSelect, Prisma.BattleLogSelect> = z.object({
...
export const BattleLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    characterId: z.boolean().optional(),
    monsterId: z.boolean().optional(),
    battleResult: z.boolean().optional(),
...
export const BattleLogFindFirstSchema: z.ZodType<Prisma.BattleLogFindFirstArgs, Prisma.BattleLogFindFirstArgs> = z.object({ select: BattleLogFindFirstSelectSchema.optional(), include: z.lazy(() => BattleLogIncludeObjectSchema.optional()), orderBy: z.union([BattleLogOrderByWithRelationInputObjectSchema, BattleLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BattleLogWhereInputObjectSchema.optional(), cursor: BattleLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BattleLogScalarFieldEnumSchema, BattleLogScalarFieldEnumSchema.array()]).optional() }).strict();

export const BattleLogFindFirstZodSchema = z.object({ select: BattleLogFindFirstSelectSchema.optional(), include: z.lazy(() => BattleLogIncludeObjectSchema.optional()), orderBy: z.union([BattleLogOrderByWithRelationInputObjectSchema, BattleLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BattleLogWhereInputObjectSchema.optional(), cursor: BattleLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BattleLogScalarFieldEnumSchema, BattleLogScalarFieldEnumSchema.array()]).optional() }).strict();