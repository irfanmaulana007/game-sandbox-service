...
export const MonsterFindFirstSelectSchema: z.ZodType<Prisma.MonsterSelect, Prisma.MonsterSelect> = z.object({
...
export const MonsterFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    level: z.boolean().optional(),
    health: z.boolean().optional(),
