...
export const CharacterFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CharacterSelect, Prisma.CharacterSelect> = z.object({
...
export const CharacterFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    name: z.boolean().optional(),
    jobId: z.boolean().optional(),
...
export const CharacterFindFirstOrThrowSchema: z.ZodType<Prisma.CharacterFindFirstOrThrowArgs, Prisma.CharacterFindFirstOrThrowArgs> = z.object({ select: CharacterFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CharacterIncludeObjectSchema.optional()), orderBy: z.union([CharacterOrderByWithRelationInputObjectSchema, CharacterOrderByWithRelationInputObjectSchema.array()]).optional(), where: CharacterWhereInputObjectSchema.optional(), cursor: CharacterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CharacterScalarFieldEnumSchema, CharacterScalarFieldEnumSchema.array()]).optional() }).strict();

export const CharacterFindFirstOrThrowZodSchema = z.object({ select: CharacterFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CharacterIncludeObjectSchema.optional()), orderBy: z.union([CharacterOrderByWithRelationInputObjectSchema, CharacterOrderByWithRelationInputObjectSchema.array()]).optional(), where: CharacterWhereInputObjectSchema.optional(), cursor: CharacterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CharacterScalarFieldEnumSchema, CharacterScalarFieldEnumSchema.array()]).optional() }).strict();