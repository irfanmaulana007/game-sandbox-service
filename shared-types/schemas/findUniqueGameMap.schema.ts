...
export const GameMapFindUniqueSchema = z.object({ select: GameMapSelectObjectSchema.optional(), include: GameMapIncludeObjectSchema.optional(), where: GameMapWhereUniqueInputObjectSchema })