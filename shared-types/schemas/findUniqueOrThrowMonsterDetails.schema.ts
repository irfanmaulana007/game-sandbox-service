...
export const MonsterDetailsFindUniqueOrThrowSchema = z.object({ select: MonsterDetailsSelectObjectSchema.optional(), include: MonsterDetailsIncludeObjectSchema.optional(), where: MonsterDetailsWhereUniqueInputObjectSchema })