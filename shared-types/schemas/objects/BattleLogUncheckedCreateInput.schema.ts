...
export const BattleLogUncheckedCreateInputObjectSchema: z.ZodType<Prisma.BattleLogUncheckedCreateInput, Prisma.BattleLogUncheckedCreateInput> = z.object({
...
export const BattleLogUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  characterId: z.string(),
  monsterId: z.number().int(),
  battleResult: BattleResultSchema,
