...
export const CharacterCreateWithoutJobInputObjectSchema: z.ZodType<Prisma.CharacterCreateWithoutJobInput, Prisma.CharacterCreateWithoutJobInput> = z.object({
...
export const CharacterCreateWithoutJobInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  level: z.number().int().optional(),
  experience: z.number().int().optional(),
