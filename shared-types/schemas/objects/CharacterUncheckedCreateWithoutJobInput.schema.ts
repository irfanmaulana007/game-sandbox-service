...
export const CharacterUncheckedCreateWithoutJobInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedCreateWithoutJobInput, Prisma.CharacterUncheckedCreateWithoutJobInput> = z.object({
...
export const CharacterUncheckedCreateWithoutJobInputObjectZodSchema = z.object({
  id: z.string().optional(),
  userId: z.string(),
  name: z.string(),
  level: z.number().int().optional(),
