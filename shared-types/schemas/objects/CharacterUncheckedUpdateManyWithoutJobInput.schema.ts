...
export const CharacterUncheckedUpdateManyWithoutJobInputObjectSchema: z.ZodType<Prisma.CharacterUncheckedUpdateManyWithoutJobInput, Prisma.CharacterUncheckedUpdateManyWithoutJobInput> = z.object({
...
export const CharacterUncheckedUpdateManyWithoutJobInputObjectZodSchema = z.object({
  userId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  level: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  experience: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
