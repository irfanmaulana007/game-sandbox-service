...
import { JobClassUpdateOneRequiredWithoutCharactersNestedInputObjectSchema } from './JobClassUpdateOneRequiredWithoutCharactersNestedInput.schema';
...
export const CharacterUpdateWithoutBattleLogsInputObjectSchema: z.ZodType<Prisma.CharacterUpdateWithoutBattleLogsInput, Prisma.CharacterUpdateWithoutBattleLogsInput> = z.object({
  ...
  job: z.lazy(() => JobClassUpdateOneRequiredWithoutCharactersNestedInputObjectSchema).optional(),
...
export const CharacterUpdateWithoutBattleLogsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  level: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  experience: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  health: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
