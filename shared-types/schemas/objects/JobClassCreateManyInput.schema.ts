...
export const JobClassCreateManyInputObjectSchema: z.ZodType<Prisma.JobClassCreateManyInput, Prisma.JobClassCreateManyInput> = z.object({
...
export const JobClassCreateManyInputObjectZodSchema = z.object({
  id: z.number().int().optional(),
  name: z.string(),
  description: z.string().nullish(),
  baseHealth: z.number().int(),
