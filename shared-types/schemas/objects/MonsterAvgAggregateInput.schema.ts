...
export const MonsterAvgAggregateInputObjectSchema: z.ZodType<Prisma.MonsterAvgAggregateInputType, Prisma.MonsterAvgAggregateInputType> = z.object({
...
export const MonsterAvgAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  level: z.literal(true).optional(),
  health: z.literal(true).optional(),
  attack: z.literal(true).optional(),
