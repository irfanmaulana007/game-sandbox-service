...
export const MonsterMaxAggregateInputObjectSchema: z.ZodType<Prisma.MonsterMaxAggregateInputType, Prisma.MonsterMaxAggregateInputType> = z.object({
...
export const MonsterMaxAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  name: z.literal(true).optional(),
  level: z.literal(true).optional(),
  health: z.literal(true).optional(),
